...
const po = document.getElementsByTagName("div");
...
function applyConfig(config) {
  ...
  if (config.enabled) {
    ...
    if (config.fontEnabled) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function() {
         jquery__WEBPACK_IMPORTED_MODULE_0___default()(po).css("font-size", config.fontsize+"px");
       });}else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function() {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(po).css("font-size","15px");
      });
    }
    if (config.spacingEnabled) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function() {
         jquery__WEBPACK_IMPORTED_MODULE_0___default()(p).css("word-spacing", config.spacingWidth+"px");
       });}else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function() {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(p).css("word-spacing","5px");
      });
    }
   if (config.lspacingEnabled) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function() {
         jquery__WEBPACK_IMPORTED_MODULE_0___default()(po).css("line-height", config.lspacingWidth+"px");
       });}else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function() {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(po).css("line-height","15px");
      });
    }
    if (config.rulerEnabled) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function() {
        document.body.appendChild(ruler);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').mousemove(function(event) {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(ruler).css('top', event.pageY - config.rulerWidth / 2);
        });
      });
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function() {
