...
function updateUI(config) {
  if (config.enabled) {
    setTimeout(function() {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.show-when-enabled').show();
    }, 100);
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.show-when-enabled').hide();
  }
  if (config.rulerEnabled) {
    setTimeout(function() {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.show-when-ruler').show();
    }, 100);
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.show-when-ruler').hide();
  }
...
function syncFormToStore(form, callback) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('input[type=checkbox]:not(:checked)', form).each(function() {
    config[this.name] = 0;
  });

  // convert string attr to int
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('input[type=checkbox]:checked', form).each(function() {
...
function syncStoreToForm(config, inputs) {
  ...
  inputs.each(function() {
    ...
    case 'range':
      this.value = value;
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('label[for="' + this.name + '"]').text(value + 'px');
      break;
    }
  });
}
...
window.onload = function() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function() {
    const inputs = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#configForm input');
    const form = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#configForm');

    // listen on changes on any form elements,
    // submit form and update all configs
    inputs.change(function() {
      if (this.type === 'range') {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('label[for="' + this.name + '"]').text(this.value + 'px');
      }
      form.submit();
    });

    // save form data to store
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#configForm').submit(function(e) {
      syncFormToStore(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this), updateUI);
      e.preventDefault();
    });
